...
function getBillData(billId,payId){var bill=new billify(billId,payId),billResult=bill.getData();if(billResult){$.extend(!0,billResult,{billId,payId})}
return billResult}